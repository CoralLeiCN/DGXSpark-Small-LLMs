...
```bash
scripts/stop nvidia/nvidia-nemotron-3-nano-30b-a3b-nvfp4
```
...
running a script. The main tuning controls are:
...
[SGLang experiment journal](../../../docs/experiments/nvidia/nvidia-nemotron-3-nano-30b-a3b-nvfp4/sglang/README.md).
